...
class ZServer : public ZCore
{
	...
	private:
		...
		void SetObjectTeam(ZObject *obj, team_type new_team);
		...
		void UpdateObjectDriverHealth(ZMannedObject *obj);
		...
		void RobotEnterObject(ZRobot *robot_obj, ZObject *dest_obj);
		...
		// Static Event handlers (not wrapped yet like in ZClient)
		static void handle_test_event(ZServer *p, char *data, int size, int player);
		static void handle_connect_event(ZServer *p, char *data, int size, int player);
		static void handle_disconnect_event(ZServer *p, char *data, int size, int player);
		static void handle_request_map_event(ZServer *p, char *data, int size, int player);
		static void handle_set_name_event(ZServer *p, char *data, int size, int player);
		static void handle_send_object_list_event(ZServer *p, char *data, int size, int player);
		static void handle_send_zone_info_list_event(ZServer *p, char *data, int size, int player);
		static void handle_set_player_name_event(ZServer *p, char *data, int size, int player);
		static void handle_set_player_team_event(ZServer *p, char *data, int size, int player);
		static void handle_rcv_object_waypoints_event(ZServer *p, char *data, int size, int player);
		static void handle_rcv_object_rallypoints_event(ZServer *p, char *data, int size, int player);
		static void handle_start_building_event(ZServer *p, char *data, int size, int player);
		static void handle_replace_building_event(ZServer *p, char *data, int size, int player);
		static void handle_stop_building_event(ZServer *p, char *data, int size, int player);
		static void handle_place_cannon_event(ZServer *p, char *data, int size, int player);
		static void handle_relay_chat_event(ZServer *p, char *data, int size, int player);
		static void handle_exit_vehicle_event(ZServer *p, char *data, int size, int player);
		static void handle_request_settings_event(ZServer *p, char *data, int size, int player);
		static void handle_set_player_mode_event(ZServer *p, char *data, int size, int player);
		static void handle_request_player_list_event(ZServer *p, char *data, int size, int player);
		static void handle_bot_login_bypass_event(ZServer *p, char *data, int size, int player);
		static void handle_get_pause_game_event(ZServer *p, char *data, int size, int player);
		static void handle_set_pause_game_event(ZServer *p, char *data, int size, int player);
		static void handle_start_vote_event(ZServer *p, char *data, int size, int player);
		static void handle_vote_yes_event(ZServer *p, char *data, int size, int player);
		static void handle_vote_no_event(ZServer *p, char *data, int size, int player);
		static void handle_vote_pass_event(ZServer *p, char *data, int size, int player);
		static void handle_request_player_id_event(ZServer *p, char *data, int size, int player);
		static void handle_request_selectable_map_list_event(ZServer *p, char *data, int size, int player);
		static void handle_player_login_event(ZServer *p, char *data, int size, int player);
		static void handle_request_login_required_event(ZServer *p, char *data, int size, int player);
		static void handle_create_user_event(ZServer *p, char *data, int size, int player);
		static void handle_buy_regkey_event(ZServer *p, char *data, int size, int player);
		static void handle_get_game_speed_event(ZServer *p, char *data, int size, int player);
		static void handle_set_game_speed_event(ZServer *p, char *data, int size, int player);
		static void handle_add_building_queue_event(ZServer *p, char *data, int size, int player);
		static void handle_cancel_building_queue_event(ZServer *p, char *data, int size, int player);
		static void handle_reshuffle_teams_event(ZServer *p, char *data, int size, int player);
		static void handle_start_bot_event(ZServer *p, char *data, int size, int player);
		static void handle_stop_bot_event(ZServer *p, char *data, int size, int player);
		static void handle_select_map_event(ZServer *p, char *data, int size, int player);
		static void handle_reset_map_event(ZServer *p, char *data, int size, int player);
		static void handle_request_version_event(ZServer *p, char *data, int size, int player);
};
