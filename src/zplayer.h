...
// TODO 5: Move the additional small classes here into separate files
...
private:
	...
	//########## END TCP event handlers ############


	//############# BEGIN Player input event handlers #################
	...
	//############# END Player input event handlers #################
	...
	// The object that was clicked last (was hover when mouse down -> mouse not moved -> was still hover when mouse up)
	ZObject* click_object;
