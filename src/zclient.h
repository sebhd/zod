...
protected:
	...
	static void handle_add_new_object_event(ZClient *p, char *data, int size, int dummy);
	static void handle_add_player_event(ZClient *p, char *data, int size, int dummy);
	static void handle_clear_player_list_event(ZClient *p, char *data, int size, int dummy);
	static void handle_connect_event(ZClient *p, char *data, int size, int dummy);
	static void handle_delete_object_event(ZClient *p, char *data, int size, int dummy);
	static void handle_delete_player_event(ZClient *p, char *data, int size, int dummy);
	static void handle_destroy_object_event(ZClient *p, char *data, int size, int dummy);
	static void handle_disconnect_event(ZClient *p, char *data, int size, int dummy);
	static void handle_display_login_event(ZClient *p, char *data, int size, int dummy);
	static void handle_display_news_event(ZClient *p, char *data, int size, int dummy);
	static void handle_do_crane_anim_event(ZClient *p, char *data, int size, int dummy);
	static void handle_do_portrait_anim_event(ZClient *p, char *data, int size, int dummy);
	static void handle_driver_hit_effect_event(ZClient *p, char *data, int size, int dummy);
	static void handle_end_game_event(ZClient *p, char *data, int size, int dummy);
	static void handle_fire_object_missile_event(ZClient *p, char *data, int size, int dummy);
	static void handle_get_version_event(ZClient *p, char *data, int size, int dummy);
	static void handle_pickup_grenade_event(ZClient *p, char *data, int size, int dummy);


	static void handle_poll_buy_regkey_event(ZClient *p, char *data, int size, int dummy);
	static void handle_request_version_event(ZClient *p, char *data, int size, int dummy);
	static void handle_reset_game_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_build_queue_list_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_building_cannon_list_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_building_state_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_computer_message_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_object_experience_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_grenade_amount_event(ZClient *p, char *data, int size, int dummy);
	//static void set_leader_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_lid_open_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_object_attack_object_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_object_group_info_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_object_health_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_object_loc_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_object_rallypoints_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_object_team_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_object_waypoints_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_player_id_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_player_ignored_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_player_loginfo_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_player_mode_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_player_name_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_player_team_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_player_voteinfo_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_regkey_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_repair_building_anim_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_selectable_map_list_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_settings_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_team_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_vote_info_event(ZClient *p, char *data, int size, int dummy);
	static void handle_set_zone_info_event(ZClient *p, char *data, int size, int dummy);
	static void handle_snipe_object_event(ZClient *p, char *data, int size, int dummy);
	static void handle_store_map_event(ZClient *p, char *data, int size, int dummy);
	static void handle_team_ended_event(ZClient *p, char *data, int size, int dummy);
	static void handle_test_event(ZClient *p, char *data, int size, int dummy);
	static void handle_update_game_paused_event(ZClient *p, char *data, int size, int dummy);
	static void handle_update_game_speed_event(ZClient *p, char *data, int size, int dummy);
