...
enum tcp_event
{
	// TODO 5: Bring this in alphabetic order
	...
	DESTROY_OBJECT, START_BUILDING, STOP_BUILDING, REPLACE_BUILDING, SET_BUILDING_STATE,
	...
	RESHUFFLE_TEAMS, START_BOT_EVENT, STOP_BOT_EVENT, SELECT_MAP, SET_EXPERIENCE, SET_LEADER, RESET_MAP, REQUEST_VERSION,
	GIVE_VERSION,
	MAX_TCP_EVENTS
};
